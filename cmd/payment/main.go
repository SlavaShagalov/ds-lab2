...
import (
	...
	"github.com/SlavaShagalov/ds-lab2/internal/payment/repository"
	"github.com/SlavaShagalov/ds-lab2/internal/payment/usecase"
	"github.com/SlavaShagalov/ds-lab2/internal/pkg/app"
	"github.com/SlavaShagalov/ds-lab2/pkg/migrations"
...
func main() {
	...
	pflag.StringVarP(&configPath, "config", "c", "configs/payment.yaml", "Config file path")
